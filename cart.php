...
<html>
<head>
<title>RM Assalam - Keranjang Saya</title>
<!-- for-mobile-apps -->
...
<!-- header -->
	<div class="agileits_header">
		<div class="container">
			...
			<p>DAPATKAN Potongan Harga di Rumah Makan Assalam, <a href="product.php">Beli SEKARANG!</a></p>
			</div>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				...
				<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : +62813 4128 4631</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">RM Assalam</a></h1>
			</div>
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Jalan Sawerigading, Malili, Luwu Timur</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">rm.assalam@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 813 4128 4631</li>
					</ul>
				</div>
				<div class="clearfix"> </div>
			</div>
